...
module.exports = {
  ...
  entry: {
    ...
    fastResilientMode: './app/blog/FastResilientMode.jsx',
    replitPrototype: './app/blog/ReplitPrototype.jsx',
    hybridGenerationalMemoryPart1: './app/blog/HybridGenerationalMemoryPart1.jsx',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({template: './app/main.html', chunks: ['fastResilientMode'], filename: 'blog/memory-model', title: "Vale's Memory Model: A Hybrid of Swift, Rust, and Arcane Sorcery - Vale", inject: true }),
    new HtmlWebpackPlugin({template: './app/main.html', chunks: ['fastResilientMode'], filename: 'blog/next-gen-memory-model', title: "Vale's Memory Model: A Hybrid of Swift, Rust, and Arcane Sorcery - Vale", inject: true }),
    new HtmlWebpackPlugin({template: './app/main.html', chunks: ['replitPrototype'], filename: 'blog/replit-prototype', title: "Vale Repl.it Prototype - Vale", inject: true }),
    new HtmlWebpackPlugin({template: './app/main.html', chunks: ['hybridGenerationalMemoryPart1'], filename: 'blog/hybrid-generational-memory-part-1', title: "Vale's Hybrid Generational Memory, Part 1 - Vale", inject: true }),
